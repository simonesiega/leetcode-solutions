...
| Do | Avoid |
|---|---|
| Give clear, useful feedback. | Personal attacks, insults, or dismissive replies. |
| Discuss the code, idea, or trade-off. | Harassment, discrimination, threats, or trolling. |
| Be patient with different experience levels. | Making someone feel unwelcome for asking a good-faith question. |
...
This Code of Conduct applies to repository content, issues, Pull Requests, reviews, discussions, and other project-related communication.

Because this repository includes company OA and interview preparation, only share problems, notes, and materials that are public or that you are permitted to publish.

Do not post private recruiter or interviewer messages, another person's application details, personal information belonging to someone else, or confidential assessment material.
...
This Code of Conduct is inspired by the [Contributor Covenant, version 2.1](https://www.contributor-covenant.org/version/2/1/code_of_conduct/).
