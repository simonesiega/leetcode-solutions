...
| 13 | [Roman to Integer](https://leetcode.com/problems/roman-to-integer/) | Easy | 2 | Solved | [13.py](solutions/13.py) | O(n), where n is the Roman numeral length | O(1) auxiliary space | n = the number of Roman numeral characters |
